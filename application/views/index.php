...
<main>
    ...
    <section>
        <div class="help">
            ...
            <div class="details container">
                <div class="title">
                    <h1>How career guidance can help you?</h1>
                </div>
    ...
    <section>
        <div class="explore">
            ...
            <div class="details container">
                <div class="title">
                    <h1>How we will help you in your Career journey?</h1>
                </div>
                <div class="underline-class"></div>
                <div class="sub-title">
                    ...
                    <div class="new-btn b-design" id="homeNav1">
                        Find your right fit
                    </div>
                </div>
            </div>
        ...
        <div class="seling">
            ...
            <div class="details container">
                ...
                <div class="sub-title">
                    ...
                    <div class="new-btn b-design" id="homeNav2">
                        Find your right fit
                    </div>
                </div>
            </div>
